// ImportS the `expect` assertion style from Chai for testing
const expect = require("chai").expect;
// Import the `it` and `describe` functions
// from Mocha for structuring the tests
const { it, describe } = require("mocha");
const calculateNumber = require("./2-calcul_chai");

describe("calculateNumber", function() {
	// Group related tests for the `calculateNumber` function
